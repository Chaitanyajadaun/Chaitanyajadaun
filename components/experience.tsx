...
const experiences = [
  {
    ...
    achievements: [
      ...
      "Mentored junior students by conducting structured web development sessions and guiding them on fundamentals.",
      "Led recruitment efforts by taking technical interviews and evaluating candidates based on their skills and problem-solving abilities."
    ],
  }
];
